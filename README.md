...
Some modifications to the Rust implementation by René Klačan of brilliant [SymSpell](https://github.com/wolfgarbe/SymSpell) originally written in C# by [@wolfgarbe](https://github.com/wolfgarbe). No changes to the API were made, use this as a faster drop-in replacement for the symspell
crate.
## Usage
